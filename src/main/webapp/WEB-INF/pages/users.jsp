    ...
    <div class="row" style="margin-top: 40px;" id="configurator">
        ...
        <div class="col-md-8 offset-2">
            <form method="post" class="form-inline needs-validation" action="${pageContext.request.contextPath}/users" novalidate>
                    ...
                    <a href="${pageContext.request.contextPath}/addUser" class="btn btn-outline-danger mb-2" style="margin-left: 20px;">Add User</a>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class = "col-md-3 d-flex" id="usersCards">
                                ...
                                <a href="${pageContext.request.contextPath}/users/${user.id}" style="float:right" class="btn btn-primary stretched-link">Details</a>
                            </div>
